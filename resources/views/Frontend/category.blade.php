...
@section('content')
	...
	<div class="section search-result-wrap">
		<div class="container">
			<div class="row">
				{{-- <div class="col-12">
					<div class="heading">Category: {{$posts->category}}</div>
				</div> --}}
			</div>
				...
				<div class="col-lg-8">
                    ...
                    @foreach ($posts as $post )
                        <div class="blog-entry d-flex blog-entry-search-item">
                            <a href="{{route('userpost.single',$post->id)}}" class="img-link me-4">
                            ...
                            <div>
                                ...
                                <h2><a href="{{route('userpost.single',$post->id)}}"></a></h2>
                                <p>{{substr($post->content,0,20)}}</p>
                                <p><a href="{{route('userpost.single',$post->id)}}" class="btn btn-sm btn-outline-primary">Read More</a></p>
                            </div>
                        </div>
                    @endforeach
